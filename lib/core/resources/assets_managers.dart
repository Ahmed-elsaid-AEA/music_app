class AssetsManagers {
  ...
  static const String loop = "$pathImage/controllers_music_image/loop.png";
  static const String next = "$pathImage/controllers_music_image/next.png";
  static const String pause = "$pathImage/controllers_music_image/pause.png";
  static const String random = "$pathImage/controllers_music_image/random.png";
  static const String back = "$pathImage/controllers_music_image/back.png";
